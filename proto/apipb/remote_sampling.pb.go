...
func (SamplingStrategyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_73a22fa60de362c1, []int{0}
}
...
func (*RateLimitingSamplingStrategy) Descriptor() ([]byte, []int) {
	return fileDescriptor_73a22fa60de362c1, []int{1}
}
...
func (*OperationSamplingStrategy) Descriptor() ([]byte, []int) {
	return fileDescriptor_73a22fa60de362c1, []int{2}
}
...
func (*PerOperationSamplingStrategies) Descriptor() ([]byte, []int) {
	return fileDescriptor_73a22fa60de362c1, []int{3}
}
...
func (*SamplingStrategyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_73a22fa60de362c1, []int{4}
}
...
func (*SamplingStrategyParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_73a22fa60de362c1, []int{5}
}
...
func init() { proto.RegisterFile("remote_sampling.proto", fileDescriptor_73a22fa60de362c1) }

var fileDescriptor_73a22fa60de362c1 = []byte{
	// 584 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *RateLimitingSamplingStrategy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxTracesPerSecond != 0 {
		i = encodeVarintRemoteSampling(dAtA, i, uint64(m.MaxTracesPerSecond))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *OperationSamplingStrategy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProbabilisticSampling != nil {
		{
			...
			i -= size
			i = encodeVarintRemoteSampling(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x12
	}
	if len(m.Operation) > 0 {
		...
		i = encodeVarintRemoteSampling(dAtA, i, uint64(len(m.Operation)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SamplingStrategyResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StrategyType != 0 {
		i = encodeVarintRemoteSampling(dAtA, i, uint64(m.StrategyType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SamplingStrategyParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ServiceName) > 0 {
		...
		i = encodeVarintRemoteSampling(dAtA, i, uint64(len(m.ServiceName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintRemoteSampling(dAtA []byte, offset int, v uint64) int {
	offset -= sovRemoteSampling(v)
	base := offset
	for v >= 1<<7 {
...
func (m *RateLimitingSamplingStrategy) Size() (n int) {
	...
	_ = l
	if m.MaxTracesPerSecond != 0 {
		n += 1 + sovRemoteSampling(uint64(m.MaxTracesPerSecond))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *OperationSamplingStrategy) Size() (n int) {
	...
	l = len(m.Operation)
	if l > 0 {
		n += 1 + l + sovRemoteSampling(uint64(l))
	}
	if m.ProbabilisticSampling != nil {
...
func (m *SamplingStrategyResponse) Size() (n int) {
	...
	_ = l
	if m.StrategyType != 0 {
		n += 1 + sovRemoteSampling(uint64(m.StrategyType))
	}
	if m.ProbabilisticSampling != nil {
		l = m.ProbabilisticSampling.Size()
		n += 1 + l + sovRemoteSampling(uint64(l))
...
func sovRemoteSampling(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozRemoteSampling(x uint64) (n int) {
	return sovRemoteSampling(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ProbabilisticSamplingStrategy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowRemoteSampling
			}
			if iNdEx >= l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipRemoteSampling(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if (skippy < 0) || (iNdEx+skippy) < 0 {
				return ErrInvalidLengthRemoteSampling
			}
			if (iNdEx + skippy) > l {
				return io.ErrUnexpectedEOF
			}
...
func skipRemoteSampling(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowRemoteSampling
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthRemoteSampling
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupRemoteSampling
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthRemoteSampling        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowRemoteSampling          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupRemoteSampling = fmt.Errorf("proto: unexpected end of group")
)
